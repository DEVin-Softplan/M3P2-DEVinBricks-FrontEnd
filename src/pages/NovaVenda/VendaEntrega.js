    ...
    return (<>
            <div className={styles.containerVEndaEntrega}>
                ...
                <div className={styles.containerInputs}>
                    <TextField className={styles.textField} helperText={error?"CEP Inválido":""} error={error} label="CEP" onChange={handleChange} onBlur={handleBlur} variant="outlined" fullWidth={true} /> <br/>
                </div>  
                <div className={styles.containerInputs}>   
                    <TextField className={styles.textField} disabled value={estado} label="Estado"  variant="outlined" />
                    
                    <TextField  className={styles.textField} label="Cidade" value={cidade} variant="outlined" /><br/>
                </div>
                <div className={styles.containerInputs}> 
                    <TextField className={styles.textField} id="textField-logradouro" label="Logradouro" value={logradouro} onChange={(data)=>setLogradouro( data.target.value)}  variant="outlined" fullWidth={true}/><br/>
                </div>
                    <div className={styles.containerInputs}>
                        <TextField className={styles.textField} label="Bairro" onChange={(data)=>setBairro( data.target.value)} value={bairro} variant="outlined" />
                        <TextField className={styles.textField} label="Complemento" value={complemento} onChange={(data)=>setComplemento( data.target.value)} variant="outlined" />
                ...
                <div className={styles.valoresCompra} >
                    <Typography sx={{fontSize:"1.5em"}}className={styles.Typography} variant="h6" gutterBottom component="div">
